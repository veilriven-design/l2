/*
 * l2 core - narrow public interface (sys.h)
 *
 * This is the complete, stable, auditable surface for the substrate.
 * All authority and boundary crossings go through these calls.
 * Implementation must be in disciplined C with memory safety guards.
 */
...
/* Core operations - map directly to L2P protocol and CLI */
