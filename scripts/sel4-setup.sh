...
- The actual port of l2-core to run as a Microkit protection domain is in
  progress. See the skeleton at `l2-source/docs/sel4/l2.system` and the plans in
...
the container) against the `docs/sel4/l2.system` description and the l2_core ELF.
...
For project status see: `~/l2/docs/STATUS.md` and the docs/ directory in l2-source.
