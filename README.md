# l2 — Minimal High-Assurance System Substrate (v0.3.9)
...
See [ROADMAP.md](ROADMAP.md) for current priorities and direction (seccomp Phase 1 hardening and L2P core split are the leading items).
