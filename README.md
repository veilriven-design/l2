# l2 — Minimal High-Assurance System Substrate (v0.4.5)
...
l2 put smoke hello.txt --content 'hello from v0.4.5'
l2 get smoke hello.txt | grep -q 'v0.4.5'
...
**v0.1.0** remains available as an immutable historical baseline for evaluation and integrity checks against v0.4.5 and future releases.
