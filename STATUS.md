...
**v0.4.5 released** — Full alignment sweep to latest (2026, to the hour) NSA and CISA guidance for AI/agentic/MCP/critical infrastructure: CPG 2.0, NSA AI/ML Supply Chain CSI, MCP Security Design for AI-Driven Automation (strict-mcp as the secure substrate), OT AI integration principles, agentic AI adoption, AI data security. harden.sh, policies, audit, and all docs updated with explicit mappings and SBOM/AIBOM recs etc. Existing l2 primitives (isolation, explicit authority, North-Star Containment demos, great-harden for critical) meet/exceed. See CHANGELOG.md. Builds on v0.4.4 (Miasma + malware-cancer North-Star grand demo + expansions). v0.4.4 tag preserved.
