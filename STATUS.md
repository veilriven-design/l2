...
**v0.4.7 released** — Full alignment sweep (another complete up-to-the-minute one June 2026) to latest NSA/CISA guidance for AI/agentic/MCP/critical infrastructure: CPG 2.0 (GOVERN etc.), NSA MCP CSI May 2026 (strict-mcp/great as secure substrate for tool/context), CISA/NSA Agentic AI Careful Adoption Apr/May 2026 (5 risks + isolation/oversight best practices), AI/ML supply chain Mar 2026, OT AI, AI data sec. harden.sh, policies, audit, and all docs updated with explicit mappings. Existing l2 primitives (isolation, explicit authority, North-Star Containment demos, great-harden for critical) meet/exceed. See CHANGELOG.md. Builds on v0.4.4 (Miasma + malware-cancer North-Star grand demo + expansions). v0.4.4 tag preserved.
