...
**v0.5.5** — `l2 net-isolate` (first-class network isolation) + spirit audit fixes + terse UX. Builds on v0.5.4 spirit + prior. "prepare prepare prepare".
